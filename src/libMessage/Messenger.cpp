                                            ...
                                            const vector<DSBlock>& dsBlocks)
{
    ...
    {
        SerializableToProtobufByteArray(dsblock, result.add_dsblocks());
    }
                                            ...
                                            vector<DSBlock>& dsBlocks)
{
    ...
    {
        DSBlock dsblock;
        ProtobufByteArrayToSerializable(result.dsblocks(i), dsblock);
                                            ...
                                            const vector<TxBlock>& txBlocks)
{
    ...
    {
        SerializableToProtobufByteArray(txblock, result.add_txblocks());
    }
                                            ...
                                            vector<TxBlock>& txBlocks)
{
    ...
    {
        TxBlock txblock;
        ProtobufByteArrayToSerializable(result.txblocks(i), txblock);
